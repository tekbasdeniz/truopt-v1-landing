...
export const RefundPolicyContentEN = () => {
    return (
        <div className="prose prose-invert max-w-none text-muted-foreground">
            ...
            <p className="mb-4">
                ...
                is the Merchant of Record for all our orders. Paddle provides all customer service inquiries and handles returns.
            </p>
            ...
            <p className="mb-4">
                Refunds are processed in accordance with Paddle’s Buyer Terms. As a consumer, you have the right to request a refund within 14 days of your purchase, subject to applicable local laws and Paddle's policies.
            </p>
            <p className="mb-8">
            ...
            <p className="mb-4">
                Since Paddle is the merchant of record, all refund and cancellation requests must be submitted directly through them. You can contact Paddle via{' '}
                <a
                ...
                or follow the instructions in your purchase confirmation email.
            </p>
            <p className="mb-8">
