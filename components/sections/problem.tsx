        ...
        <section id="problem" className="relative py-20 md:py-32 overflow-hidden">
            ...
            <Container className="relative z-10">
                ...
                >
                    ...
                    <div className="relative p-6 md:p-8 rounded-2xl border border-[#6b4cff]/30 bg-black/40 backdrop-blur-xl flex flex-col sm:flex-row items-start sm:items-center gap-6 overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 hover:border-[#6b4cff]/60 hover:shadow-[0_0_40px_-10px_rgba(107,76,255,0.4)]">
                        <motion.div 
